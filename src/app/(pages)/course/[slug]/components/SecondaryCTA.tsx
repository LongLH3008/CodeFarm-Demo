...
const SecondaryCTA = () => {
  return (
    <div className="sticky duration-200 w-fit layout_responsive bottom-0 border-t max-md:flex-col max-md:gap-3 md:items-center flex justify-between py-3 md:py-5 bg-white">
      ...
      <div className="justify-end flex max-md:w-full gap-3 max-md:grid max-md:grid-cols-2">
        <Button className="max-md:w-full bg-zinc-100 text-zinc-600 cursor-pointer w-fit p-5 text-[17px] flex items-center gap-1 active:scale-[0.9] md:rounded-full duration-200">
          <PhoneCall />
          Tư vấn
        </Button>
        {/* <Button className="max-md:w-full button_primary w-fit p-5 text-[17px] md:rounded-full"></Button> */}
        <StyledButton
          variant="primary"
